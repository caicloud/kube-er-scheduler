...
// ExtensionsV1alpha1Client is used to interact with features provided by the extensions group.
type ExtensionsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExtensionsV1alpha1Client) ExtendedResources() ExtendedResourceInterface {
	return newExtendedResources(c)
}

func (c *ExtensionsV1alpha1Client) ExtendedResourceClaims(namespace string) ExtendedResourceClaimInterface {
